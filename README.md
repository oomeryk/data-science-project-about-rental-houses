...
Web scraping on two sites using selenium libraries in python. Analyzing and visualization the extracted data with pandas - numpy - matplotlib - seaborn libraries. Create machine learning algorithms and showing predicted price and many useful output using based on entered, desired rental house informations in Türkiye.
