...
Web scraping on two sites using selenium. Analyzing and visualization the extracted data with pandas - numpy - matplotlib - seaborn. Create machine learning algorithms and showing predicted price and many useful output using based on entered, desired rental house informations in Türkiye.
